...
namespace CppProject
{
	IntType list_init_context_menu(ScopeAny self, VarType name)
	{
		...
		if (sStr(context_menu_value_name) != /*""*/ STR(0))
		{
			...
			{
				case 1500: // pathoffset
				{
					list_item_add(text_get({ /*"contextmenupathsetlength"*/ STR(1501) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_frame_path_offset_set_length);
					break;
				}
		...
		{
			case 1057: // contextmenuvalue
			case 1502: // contextmenucategory
			{
				if (sInt(context_menu_group) == e_context_group_SCALE && sReal(setting_advanced_mode) > 0)
				{
					StringType text = ((ObjType(obj_category, ObjType(obj_tab, sInt(frame_editor))->transform)->scale_all > 0) ? /*"contextmenuscaleseparate"*/ STR(1503) : /*"contextmenuscalecombine"*/ STR(1504));
					list_item_add(text_get({ text }), null_, /*""*/ STR(0), null_, icons_SCALE, null_, ID_action_group_combine_scale, true);
				}
				if (name == /*"contextmenuvalue"*/ STR(1057))
				{
					list_item_add(text_get({ /*"contextmenuvaluecut"*/ STR(1505) }), null_, /*""*/ STR(0), null_, icons_CUT, null_, ID_action_value_cut, true);
					list_item_add(text_get({ /*"contextmenuvaluecopy"*/ STR(1506) }), null_, /*""*/ STR(0), null_, icons_COPY, null_, ID_action_value_copy, false);
					...
					list_item_add(text_get({ /*"contextmenuvaluepaste"*/ STR(1507) }), null_, caption, null_, icons_PASTE, null_, ID_action_value_paste, false);
					...
					list_item_add(text_get({ /*"contextmenuvaluereset"*/ STR(1508) }), null_, /*""*/ STR(0), null_, icons_RESET, null_, ID_action_value_reset, false);
				}
				if (sInt(context_menu_group) != null_)
				{
					list_item_add(text_get({ /*"contextmenugroupcopy"*/ STR(1509) }), null_, /*""*/ STR(0), null_, icons_COPY_ALL, null_, ID_action_group_copy, true);
					list_item_add(text_get({ /*"contextmenugrouppaste"*/ STR(1510) }), null_, /*""*/ STR(0), null_, icons_PASTE_ALL, null_, ID_action_group_paste, false);
					...
					list_item_add(text_get({ /*"contextmenugroupreset"*/ STR(1511) }), null_, /*""*/ STR(0), null_, icons_RESET_ALL, null_, ID_action_group_reset, false);
					if (sInt(context_menu_group) == e_context_group_POSITION)
						list_item_add(text_get({ /*"contextmenugroupcopyglobalposition"*/ STR(1512) }), null_, /*""*/ STR(0), null_, icons_COPY_ALL, null_, ID_action_group_copy_global, true);
				}
				if (sVar(context_menu_value_type) == e_context_type_COLOR)
				{
					list_item_add(text_get({ /*"contextmenusetcolor"*/ STR(1513) }), null_, /*""*/ STR(0), null_, icons_PALETTE, icons_CHEVRON_RIGHT_TINY, null_, true);
					ObjType(obj_list_item, global::list_item_last)->context_menu_script = ID_menu_swatches_draw;
					ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"contextmenuswatchset"*/ STR(1514);
					...
					list_item_add(text_get({ /*"contextmenumixcolor"*/ STR(1515) }), null_, /*""*/ STR(0), null_, icons_PLUS, icons_CHEVRON_RIGHT_TINY);
					ObjType(obj_list_item, global::list_item_last)->context_menu_script = ID_menu_swatches_draw;
					ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"contextmenuswatchmix"*/ STR(1516);
					ObjType(obj_list_item, global::list_item_last)->context_menu_width = IntType(204);
					ObjType(obj_list_item, global::list_item_last)->context_menu_height = IntType(0);
				}
				break;
			...
			case 1064: // contextmenutextbox
			{
				list_item_add(text_get({ /*"contextmenutextboxcut"*/ STR(1517) }), null_, text_control_name(keybind_new(/*"X"*/ STR(276), true)), null_, icons_CUT, null_, ID_action_textbox_cut, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(textbox_select_startpos) == sVar(textbox_select_endpos));
				list_item_add(text_get({ /*"contextmenutextboxcopy"*/ STR(1518) }), null_, text_control_name(keybind_new(/*"C"*/ STR(274), true)), null_, icons_COPY, null_, ID_action_textbox_copy, false);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(textbox_select_startpos) == sVar(textbox_select_endpos));
				list_item_add(text_get({ /*"contextmenutextboxpaste"*/ STR(1519) }), null_, text_control_name(keybind_new(/*"V"*/ STR(278), true)), null_, icons_PASTE, null_, ID_action_textbox_paste, false);
				ObjType(obj_list_item, global::list_item_last)->disabled = (clipboard_get_text() == /*""*/ STR(0) || !clipboard_has_text());
				list_item_add(text_get({ /*"contextmenutextboxselectall"*/ STR(1520) }), null_, text_control_name(keybind_new(/*"A"*/ STR(265), true)), null_, icons_SELECT_ALL, null_, ID_action_textbox_select_all, false);
				break;
			}
			
			case 1521: // timelinelist
			{
				list_item_add(text_get({ /*"contextmenutladdfolder"*/ STR(1522) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_CREATE_FOLDER))->keybind), null_, icons_FOLDER, null_, ID_action_tl_folder, true);
				list_item_add(text_get({ /*"contextmenutlselectkeyframes"*/ STR(1523) }), sVar(context_menu_value), /*""*/ STR(0), null_, icons_KEYFRAME, null_, ID_action_tl_select_keyframes);
				...
				{
					list_item_add(text_get({ /*"contextmenutlcolortag"*/ STR(1524) }), null_, /*""*/ STR(0), null_, icons_TAG, icons_CHEVRON_RIGHT_TINY, null_);
					ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"colortag"*/ STR(1525);
					ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				}
				list_item_add(text_get({ /*"contextmenutlexpandchildren"*/ STR(1526) }), null_, /*""*/ STR(0), null_, icons_MAXIMIZE, null_, ID_action_tl_extend_children);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add(text_get({ /*"contextmenutlcollapsechildren"*/ STR(1527) }), null_, /*""*/ STR(0), null_, icons_MINIMIZE, null_, ID_action_tl_collapse_children);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add(text_get({ /*"contextmenutlduplicate"*/ STR(1528) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DUPLICATE))->keybind), null_, icons_DUPLICATE, null_, ID_action_tl_duplicate, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add(text_get({ /*"contextmenutldelete"*/ STR(1529) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DELETE))->keybind), null_, icons_DELETE, null_, ID_action_tl_remove);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add(text_get({ /*"contextmenutlexport"*/ STR(1530) }), null_, /*""*/ STR(0), null_, icons_ASSET_EXPORT, null_, ID_object_save);
				...
				list_item_add(text_get({ /*"contextmenutlselectall"*/ STR(1531) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_SELECT))->keybind), null_, icons_SELECT_ALL, null_, ID_action_tl_select_all, true);
				list_item_add(text_get({ /*"contextmenutlexpandall"*/ STR(1532) }), null_, /*""*/ STR(0), null_, icons_MAXIMIZE, null_, ID_action_tl_extend_all);
				list_item_add(text_get({ /*"contextmenutlcollapseall"*/ STR(1533) }), null_, /*""*/ STR(0), null_, icons_MINIMIZE, null_, ID_action_tl_collapse_all);
				break;
			}
			
			case 125: // timeline
			{
				list_item_add(text_get({ /*"contextmenutlkeyframestransition"*/ STR(1534) }), null_, /*""*/ STR(0), null_, icons_EASE_IN_OUT, icons_CHEVRON_RIGHT_TINY, null_, true);
				...
				ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"timelinelkeyframetransitions"*/ STR(1535);
				list_item_add(text_get({ /*"contextmenutlkeyframescut"*/ STR(1536) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_CUT))->keybind), null_, icons_CUT_KEYFRAME, null_, ID_action_tl_keyframes_cut, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes);
				list_item_add(text_get({ /*"contextmenutlkeyframescopy"*/ STR(1537) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_COPY))->keybind), null_, icons_COPY_KEYFRAME, null_, ID_tl_keyframes_copy);
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes);
				list_item_add(text_get({ /*"contextmenutlkeyframespaste"*/ STR(1538) }), sVar(timeline_insert_pos), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_PASTE))->keybind), null_, icons_PASTE_KEYFRAME, null_, ID_action_tl_keyframes_paste);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sInt(copy_kf_amount) == IntType(0));
				list_item_add(text_get({ /*"contextmenutlkeyframesdelete"*/ STR(1539) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_DELETE))->keybind), null_, icons_DELETE_KEYFRAME, null_, ID_action_tl_keyframes_remove);
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes);
				list_item_add(text_get({ /*"contextmenutlkeyframesexport"*/ STR(1540) }), null_, /*""*/ STR(0), null_, icons_SAVE_KEYFRAME, null_, ID_keyframes_save);
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes_export);
				list_item_add(text_get({ /*"contextmenutlkeyframesselect"*/ STR(1541) }), null_, /*""*/ STR(0), null_, icons_SELECT_ALL_KEYFRAME, icons_CHEVRON_RIGHT_TINY, null_);
				ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"timelinelkeyframesselect"*/ STR(1542);
				list_item_add(text_get({ /*"contextmenutlkeyframeswalk"*/ STR(1543) }), sStr(timeline_settings_walk_fn), /*""*/ STR(0), null_, icons_WALK_CYCLE, null_, ID_action_tl_load_loop, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = !file_exists_lib(sStr(timeline_settings_walk_fn));
				list_item_add(text_get({ /*"contextmenutlkeyframesrun"*/ STR(1544) }), sStr(timeline_settings_run_fn), /*""*/ STR(0), null_, icons_RUN_CYCLE, null_, ID_action_tl_load_loop);
				ObjType(obj_list_item, global::list_item_last)->disabled = !file_exists_lib(sStr(timeline_settings_run_fn));
				list_item_add(text_get({ /*"contextmenutlmarkeradd"*/ STR(1545) }), null_, /*""*/ STR(0), null_, icons_MARKER_ADD, null_, ID_action_tl_marker_new, true);
			...
			case 1542: // timelinelkeyframesselect
			{
				list_item_add(text_get({ /*"contextmenutlkeyframesselectbefore"*/ STR(1546) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_before_marker);
				list_item_add(text_get({ /*"contextmenutlkeyframesselectafter"*/ STR(1547) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_after_marker);
				list_item_add(text_get({ /*"contextmenutlkeyframesselectfirst"*/ STR(1548) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_first);
				list_item_add(text_get({ /*"contextmenutlkeyframesselectlast"*/ STR(1549) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_last);
				list_item_add(text_get({ /*"contextmenutlkeyframesselectregion"*/ STR(1550) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_region);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(timeline_region_start) == null_);
				break;
			}
			
			case 1551: // timelinemarker
			{
				list_item_add(text_get({ /*"contextmenutlmarkeredit"*/ STR(1552) }), sVar(context_menu_value), /*""*/ STR(0), null_, icons_PENCIL, null_, ID_action_tl_marker_editor, true);
				list_item_add(text_get({ /*"contextmenutlmarkerdelete"*/ STR(1553) }), null_, /*""*/ STR(0), null_, icons_DELETE, null_, ID_action_tl_marker_delete);
				break;
			}
			
			case 1525: // colortag
			{
				list_item_add(text_get({ /*"contextmenucolornone"*/ STR(1554) }), null_, /*""*/ STR(0), null_, icons_CLOSE, null_, ID_action_tl_color_tag_remove, true);
				for (IntType i = IntType(0); i <= IntType(8); i++)
				{
					list_item_add(text_get({ /*"contextmenucolor"*/ STR(1555) + string(i) }), i, /*""*/ STR(0), ID_spr_16, null_, null_, ID_action_tl_color_tag);
					ObjType(obj_list_item, global::list_item_last)->thumbnail_blend = ObjType(obj_theme, sInt(setting_theme))->accent_list.Value(i);
				}
				break;
			}
			
			case 1556: // toolbarfile
			{
				list_item_add(text_get({ /*"toolbarfilenew"*/ STR(1557) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_NEW))->keybind), null_, icons_FILE, null_, ID_action_toolbar_new);
				list_item_add(text_get({ /*"toolbarfileopen"*/ STR(1558) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_OPEN))->keybind), null_, icons_FOLDER, null_, ID_action_toolbar_open);
				list_item_add(text_get({ /*"toolbarfilerecent"*/ STR(1559) }), VarType(), /*""*/ STR(0), null_, icons_FOLDER_RECENTS, icons_CHEVRON_RIGHT_TINY, null_);
				ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"toolbarfilerecent"*/ STR(1559);
				list_item_add(text_get({ /*"toolbarfilelastbackup"*/ STR(1560) }), VarType(), /*""*/ STR(0), null_, icons_RECENTS, null_, ID_action_toolbar_open_last_backup);
				ObjType(obj_list_item, global::list_item_last)->disabled = !file_exists(sStr(project_folder) + /*"/"*/ STR(19) + filename_name(sStr(project_folder)) + /*".backup1"*/ STR(78));
				list_item_add(text_get({ /*"toolbarfilesave"*/ STR(1561) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_SAVE))->keybind), null_, icons_SAVE, null_, ID_action_toolbar_save, true);
				list_item_add(text_get({ /*"toolbarfilesaveas"*/ STR(1562) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_SAVE_AS))->keybind), null_, icons_SAVE_AS, null_, ID_action_toolbar_save_as);
				if (sStr(window_state) == /*""*/ STR(0))
				{
					list_item_add(text_get({ /*"toolbarfileimport"*/ STR(1563) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_IMPORT_ASSET))->keybind), null_, icons_ASSET_IMPORT, null_, ID_action_toolbar_import_asset, true);
					list_item_add(text_get({ /*"toolbarfileworldimport"*/ STR(1564) }), VarType(), /*""*/ STR(0), null_, icons_SCENERY, null_, ID_world_import_begin, false);
				}
				break;
			}
			
			case 1559: // toolbarfilerecent
			{
				VarType recent;
			...
			case 1565: // toolbaredit
			{
				list_item_add(text_get({ /*"toolbareditundo"*/ STR(1566) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_UNDO))->keybind), null_, icons_UNDO, null_, ID_action_toolbar_undo);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sReal(history_pos) == sReal(history_amount));
				list_item_add(text_get({ /*"toolbareditredo"*/ STR(1567) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_REDO))->keybind), null_, icons_REDO, null_, ID_action_toolbar_redo);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sReal(history_pos) == IntType(0));
				list_item_add(text_get({ /*"toolbareditselectall"*/ STR(1568) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_SELECT))->keybind), null_, icons_SELECT_ALL, null_, ID_action_tl_select_all, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (ds_list_size(sInt(tree_list)) == IntType(0));
				list_item_add(text_get({ /*"toolbareditduplicate"*/ STR(1569) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DUPLICATE))->keybind), null_, icons_DUPLICATE, null_, ID_action_tl_duplicate, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add(text_get({ /*"toolbareditdelete"*/ STR(1570) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DELETE))->keybind), null_, icons_DELETE, null_, ID_action_tl_remove);
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add(text_get({ /*"toolbaredithide"*/ STR(1571) }), true, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_HIDE))->keybind), null_, icons_HIDDEN, null_, ID_action_tl_hide_select, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add(text_get({ /*"toolbareditshowhidden"*/ STR(1572) }), false, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_SHOW_HIDDEN))->keybind), null_, icons_VISIBLE, null_, ID_action_tl_hide_select);
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add(text_get({ /*"toolbareditpreferences"*/ STR(1573) }), sInt(settings), /*""*/ STR(0), null_, icons_SETTINGS, null_, (ObjType(obj_tab, sInt(settings))->show > 0) ? ID_tab_close : ID_tab_show, true);
				ObjType(obj_list_item, global::list_item_last)->toggled = ObjType(obj_tab, sInt(settings))->show;
				break;
			}
			
			case 1574: // toolbarrender
			{
				list_item_add(text_get({ /*"toolbarrenderimage"*/ STR(1575) }), null_, /*""*/ STR(0), null_, icons_IMAGE_EXPORT, null_, ID_action_toolbar_export_image);
				list_item_add(text_get({ /*"toolbarrenderanimation"*/ STR(1576) }), null_, /*""*/ STR(0), null_, icons_MOVIE_EXPORT, null_, ID_action_toolbar_export_movie);
				break;
			}
			
			case 1577: // toolbarview
			{
				if (sStr(window_state) == /*""*/ STR(0))
				{
					list_item_add(text_get({ /*"toolbarviewreset"*/ STR(1578) }), null_, /*""*/ STR(0), null_, icons_CAMERA, null_, ID_camera_work_reset);
					list_item_add(text_get({ /*"toolbarviewsecondaryview"*/ STR(1579) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_SECONDARY_VIEW))->keybind), null_, icons_VIEWPORT_SECONDARY, null_, ID_action_setting_secondary_view);
					ObjType(obj_list_item, global::list_item_last)->toggled = ObjType(obj_view, sInt(view_second))->show;
					list_item_add(text_get({ /*"toolbarviewtimelineshowmarkers"*/ STR(1580) }), null_, /*""*/ STR(0), null_, icons_MARKER, null_, ID_action_setting_timeline_show_markers);
					...
					list_item_add(text_get({ /*"toolbarviewtimelineplayback"*/ STR(1581) }), null_, /*""*/ STR(0), null_, icons_CLOCK, icons_CHEVRON_RIGHT_TINY, null_);
					ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"toolbarviewtimelineplayback"*/ STR(1581);
				}
				list_item_add(text_get({ /*"toolbarviewshortcutsbar"*/ STR(1582) }), null_, /*""*/ STR(0), null_, icons_KEYBOARD, null_, ID_action_setting_shortcuts_bar, true);
				ObjType(obj_list_item, global::list_item_last)->toggled = sBool(setting_show_shortcuts_bar);
				list_item_add(text_get({ /*"toolbarviewhome"*/ STR(1583) }), null_, /*""*/ STR(0), null_, icons_HOME, null_, ID_action_setting_home_screen, true);
				break;
			}
			
			case 1581: // toolbarviewtimelineplayback
			{
				list_item_add(text_get({ /*"toolbarviewtimelineplaybacktimeseconds"*/ STR(1584) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_setting_timeline_display_time);
				ObjType(obj_list_item, global::list_item_last)->toggled = !(sReal(timeline_show_frames) > 0);
				ObjType(obj_list_item, global::list_item_last)->divider = true;
				list_item_add(text_get({ /*"toolbarviewtimelineplaybacktimeframes"*/ STR(1585) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_setting_timeline_display_frames);
				ObjType(obj_list_item, global::list_item_last)->toggled = sReal(timeline_show_frames);
				break;
			}
			
			case 1586: // toolbarhelp
			{
				list_item_add(text_get({ /*"toolbarhelpabout"*/ STR(1587) }), sInt(popup_about), /*""*/ STR(0), null_, icons_INFO, null_, ID_popup_show);
				if (global::trial_version > 0)
					list_item_add(text_get({ /*"toolbarhelpupgrade"*/ STR(1588) }), sInt(popup_upgrade), /*""*/ STR(0), null_, icons_KEY, null_, ID_popup_show);
				list_item_add(text_get({ /*"toolbarhelptutorials"*/ STR(1589) }), link_tutorials, /*""*/ STR(0), null_, icons_TUTORIALS, null_, ID_popup_open_url);
				list_item_add(text_get({ /*"toolbarhelpreport"*/ STR(1590) }), link_forums_bugs, /*""*/ STR(0), null_, icons_BUG, null_, ID_popup_open_url, true);
				list_item_add(text_get({ /*"toolbarhelpforums"*/ STR(1591) }), link_forums, /*""*/ STR(0), null_, icons_COMMENTS, null_, ID_popup_open_url);
				break;
			}
			
			case 1066: // keybind
			{
				list_item_add(text_get({ /*"contextmenurestorekeybind"*/ STR(1592) }), sVar(context_menu_value), /*""*/ STR(0), null_, icons_RESET, null_, ID_keybind_restore);
				break;
			}
	...
	IntType list_init_end(ScopeAny self)
	{
		...
		if (sVar(menu_filter) != /*""*/ STR(0))
		{
			...
			if (filter)
			{
				...
				{
					name = string_lower(ObjType(obj_list_item, DsList(ObjType(obj_list, list)->item).Value(i))->name);
					name = string_replace_all(name, /*"normal"*/ STR(603), string_lower(sVar(menu_filter_normal)));
					if (!string_contains(name, string_lower(sVar(menu_filter))))
					{
	...
	void load_start(ScopeAny self, IntType object, IntType script)
	{
		if (sInt(popup) != sInt(popup_loading))
		{
			...
			sStr(popup_ani_type) = /*"show"*/ STR(723);
		}
		...
		sVar(window_busy) = /*"popup"*/ STR(1593) + idVar(sInt(popup), name);
	}
	...
	void marker_editor_draw(ScopeAny self)
	{
		...
		tab_next(self);
		VarType text, color;
		text = text_get({ /*"timelinemarkercolor"*/ STR(1465) + string(idVar(sVar(timeline_marker_edit), color)) });
		color = ObjType(obj_theme, sInt(setting_theme))->accent_list.Value(idVar(sVar(timeline_marker_edit), color));
		tab_control_menu(self);
		draw_button_menu(self, { /*"timelinemarkercolor"*/ STR(1465), e_menu_LIST, sVar(dx), sVar(dy), sVar(settings_menu_w) - IntType(24), IntType(24), idVar(sVar(timeline_marker_edit), color), text, ID_action_tl_marker_color, false, ID_spr_16, null_, /*""*/ STR(0), color, IntType(1) });
		tab_next(self);
	...
	{
		log({ /*"External library"*/ STR(1273), path });
				...
				if (idVar(tl, part_of) != null_)
				{
					if (idVar(idVar(tl, part_of), parent) != global::_app->id)
					{
						if (idVar(idVar(tl, part_of), parent) == root)
							caption += /*"/"*/ STR(19) + idVar(idVar(tl, part_of), display_name);
						else
							caption += /*"/.../"*/ STR(1652) + idVar(idVar(tl, part_of), display_name);
					...
					if (root != idVar(tl, parent))
						caption += /*"/.../"*/ STR(1652) + idVar(idVar(tl, parent), display_name);
				
			}
			list_item_add(string_remove_newline(idVar(tl, display_name)), tl, caption);
			if (ds_list_size(idInt(tl, tree_list)) && !sBool(menu_expose))
				list_item_add_action(global::list_item_last, string(tl) + /*"extend"*/ STR(1653), ID_menu_item_set_extend, idVar(tl, tree_extend), tl, null_, /*"left"*/ STR(197), (idVar(tl, tree_extend) > 0) ? /*"tooltiptlcollapse"*/ STR(1654) : /*"tooltiptlexpand"*/ STR(1655), ID_spr_chevron_ani);
		}
	...
	IntType menu_biome_init(ScopeAny self, VarType menu)
	{
		...
		for (IntType b = IntType(0); b < ds_list_size(global::biome_list); b++)
		{
			...
			if (!(sBool(menu_expose) && ObjType(obj_biome, biome)->group > 0))
				menu_add_item({ ObjType(obj_biome, biome)->name, minecraft_asset_get_name(/*"biome"*/ STR(1656), ObjType(obj_biome, biome)->name) });
			if (ObjType(obj_biome, biome)->biome_variants != null_ && ds_list_size(ObjType(obj_biome, biome)->biome_variants) > IntType(0))
			{
				if (!sBool(menu_expose))
					list_item_add_action(global::list_item_last, string(biome) + /*"extend"*/ STR(1653), ID_menu_item_set_extend, ObjType(obj_biome, biome)->variants_extend, biome, null_, /*"left"*/ STR(197), (ObjType(obj_biome, biome)->variants_extend > 0) ? /*"tooltiptlcollapse"*/ STR(1654) : /*"tooltiptlexpand"*/ STR(1655), ID_spr_chevron_ani);
				if (ObjType(obj_biome, biome)->variants_extend > 0 || sBool(menu_expose))
				{
					...
					{
						if (ObjType(obj_biome, DsList(ObjType(obj_biome, biome)->biome_variants).Value(v))->name == /*"normal"*/ STR(603) && !sBool(menu_expose))
							continue;
						menu_add_item({ ObjType(obj_biome, DsList(ObjType(obj_biome, biome)->biome_variants).Value(v))->name, minecraft_asset_get_name(/*"biome"*/ STR(1656), ObjType(obj_biome, DsList(ObjType(obj_biome, biome)->biome_variants).Value(v))->name) });
						if (!sBool(menu_expose))
