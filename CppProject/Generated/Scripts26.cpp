...
namespace CppProject
{
	...
	void colorpicker_draw(ScopeAny self)
	{
		...
		if (app_mouse_box(self, bx, by, bw, bh))
		{
			...
			if (sBool(mouse_left))
				sVar(window_busy) = /*"colorpickersatbripick"*/ STR(1009);
		}
		if (sVar(window_busy) == /*"colorpickersatbripick"*/ STR(1009))
		{
			if (!sBool(mouse_left))
			{
		...
		if (app_mouse_box(self, bx - IntType(8), by, bw + IntType(16), bh))
		{
			sInt(mouse_cursor) = cr_handpoint;
			if (sBool(mouse_left))
				sVar(window_busy) = /*"colorpickerhuepick"*/ STR(1010);
		}
		if (sVar(window_busy) == /*"colorpickerhuepick"*/ STR(1010))
		{
			if (!sBool(mouse_left))
			{
				sVar(window_busy) = /*""*/ STR(0);
		...
		togglebutton_add(self, { /*"colorpickerrgb"*/ STR(1011), null_, /*"rgb"*/ STR(1012), ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"rgb"*/ STR(1012), ID_colorpicker_set_mode });
		togglebutton_add(self, { /*"colorpickerhsv"*/ STR(1013), null_, /*"hsv"*/ STR(1014), ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hsv"*/ STR(1014), ID_colorpicker_set_mode });
		togglebutton_add(self, { /*"colorpickerhex"*/ STR(1015), null_, /*"hex"*/ STR(1016), ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hex"*/ STR(1016), ID_colorpicker_set_mode });
		draw_togglebutton(self, /*"colorpickermode"*/ STR(1017), sVar(dx), sVar(dy), true, false);
		tab_next(self);
		if (ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"rgb"*/ STR(1012))
		{
			textfield_group_add(self, { /*"colorpickerr"*/ STR(1018), color_get_red((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color)), color_get_red((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def)), ID_colorpicker_red, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_red });
			textfield_group_add(self, { /*"colorpickerg"*/ STR(1019), color_get_green((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color)), color_get_green((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def)), ID_colorpicker_green, Y_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_green });
			textfield_group_add(self, { /*"colorpickerb"*/ STR(1020), color_get_blue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color)), color_get_blue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def)), ID_colorpicker_blue, Z_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_blue });
			if (draw_textfield_group(self, /*"colorpickerrgb"*/ STR(1011), sVar(dx), sVar(dy), IntType(176), IntType(1), IntType(0), IntType(255), IntType(1), false, false, IntType(3), true, false))
			{
			...
			if (ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hsv"*/ STR(1014))
			{
				textfield_group_add(self, { /*"colorpickerh"*/ STR(1021), floor(color_get_hue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color))), floor(color_get_hue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def))), ID_colorpicker_hue, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hue });
				textfield_group_add(self, { /*"colorpickers"*/ STR(1022), floor(color_get_saturation((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color))), floor(color_get_saturation((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def))), ID_colorpicker_saturation, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_saturation });
				textfield_group_add(self, { /*"colorpickerv"*/ STR(1023), floor(color_get_value((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color))), floor(color_get_value((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def))), ID_colorpicker_brightness, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_brightness });
				VarType update = draw_textfield_group(self, /*"colorpickerhsv"*/ STR(1013), sVar(dx), sVar(dy), IntType(176), IntType(1), IntType(0), IntType(255), IntType(1), false, false, IntType(0), true, false);
				...
				if (ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hex"*/ STR(1016))
				{
					if (draw_inputbox(self, { /*"colorpickerhex"*/ STR(1015), sVar(dx), sVar(dy), IntType(176), IntType(24), color_to_hex(ObjType(obj_colorpicker, sInt(colorpicker))->def), ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hexadecimal, null_ }))
					...
					if (ObjType(obj_textbox, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hexadecimal)->text == /*""*/ STR(0) && sVar(window_focus) == /*""*/ STR(0))
						ObjType(obj_textbox, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hexadecimal)->text = /*"000000"*/ STR(660);
				}
	...
	{
		if (sStr(settings_menu_name) == /*"colorpicker"*/ STR(680) && ObjType(obj_colorpicker, sInt(colorpicker))->value_script == script)
			popup_close(self);
		else
		{
			...
			sStr(settings_menu_name) = /*"colorpicker"*/ STR(680);
			...
			ObjType(obj_colorpicker, sInt(colorpicker))->mode = /*"rgb"*/ STR(1012);
	...
	void colorpicker_startup()
	{
		...
		withOne (obj_colorpicker, global::_app->colorpicker, global::_app->id)
		{
			...
			self->tbx_red = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1025));
			self->tbx_green = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1025));
			self->tbx_blue = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1025));
			self->tbx_hue = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1025));
			self->tbx_saturation = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1025));
			self->tbx_brightness = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1025));
			self->tbx_hexadecimal = new_textbox_hex();
			self->mode = /*"rgb"*/ STR(1012);
		}
	...
	BoolType context_menu_area(ScopeAny self, VarArgs argument)
	{
		...
		if (app_mouse_box(self, xx, yy, wid, hei) && sBool(mouse_right_pressed))
		{
			...
			sVar(window_busy) = /*"contextmenu"*/ STR(1026);
	...
	RealType context_menu_draw(ScopeAny self)
	{
		if (sInt(context_menu_level_amount) == IntType(0) || sInt(context_menu_window) != window_get_current())
			return IntType(0);
		if (ObjType(obj_context_menu_level, DsList(sInt(context_menu_level)).Value(IntType(0)))->ani == IntType(0) && sStr(context_menu_ani) == /*"hide"*/ STR(722))
		{
		...
		if (((sBool(mouse_left_pressed) || sBool(mouse_right_pressed)) && !sBool(context_menu_mouseon)) || (sBool(mouse_left_released) && (!sBool(context_menu_mouseon) || (sInt(context_menu_mouseon_item) != null_ && !idBool(sInt(context_menu_mouseon_item), disabled) && idVar(sInt(context_menu_mouseon_item), context_menu_name) == /*""*/ STR(0)))))
			sStr(context_menu_ani) = /*"hide"*/ STR(722);
	...
	RealType context_menu_draw_level(ScopeAny self, IntType argument0)
	{
		...
		if (sStr(context_menu_ani) == /*""*/ STR(0) || sStr(context_menu_ani) == /*"open"*/ STR(896))
		{
	...
	VarType debug(VarArgs argument)
	{
		...
		cap = string_repeat(/*"\t"*/ STR(1027), global::debug_indent) + string(argument[IntType(0)]);
		valstr = /*""*/ STR(0);
