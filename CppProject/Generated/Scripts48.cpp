...
namespace CppProject
{
	...
	RealType render_generate_text(ScopeAny self, VarArgs argument)
	{
		...
		halign = /*"center"*/ STR(1422);
		valign = /*"center"*/ STR(1422);
		aa = true;
		alignmatch = true;
		aamatch = true;
		...
		hei = string_height_ext(str, (IntType)(string_height(/*" "*/ STR(20)) - IntType(2)), -IntType(1)) + IntType(1);
		...
		surface_set_target(surf);
	{
		...
		draw_text_ext((IntType)(textxx), -IntType(1), str, (IntType)(string_height(/*" "*/ STR(20)) - IntType(2)), -IntType(1));
		draw_set_halign(fa_left);
