...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3829) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3830) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3831))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3832) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3831))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3831))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3833))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3834))
		{
			sInt(mouse_cursor) = cr_size_ns;
