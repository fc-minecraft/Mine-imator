...
namespace CppProject
{
	...
	void app_startup_keybinds()
	{
		...
		keybind_register(/*"markerleft"*/ STR(282), e_keybind_MARKER_LEFT, keybind_new(vk_left), true);
		keybind_register(/*"markerright"*/ STR(283), e_keybind_MARKER_RIGHT, keybind_new(vk_right), true);
		keybind_register(/*"rendermode"*/ STR(284), e_keybind_RENDER_MODE, keybind_new(vk_f5));
		keybind_register(/*"particlesspawn"*/ STR(285), e_keybind_PARTICLES_SPAWN, keybind_new(/*"X"*/ STR(276)));
		keybind_register(/*"particlesclear"*/ STR(286), e_keybind_PARTICLES_CLEAR, keybind_new(/*"C"*/ STR(274)));
		keybind_register(/*"secondaryview"*/ STR(287), e_keybind_SECONDARY_VIEW, keybind_new(vk_f6));
		keybind_register(/*"toolselect"*/ STR(288), e_keybind_TOOL_SELECT, keybind_new(/*"W"*/ STR(289)));
		keybind_register(/*"toolmove"*/ STR(290), e_keybind_TOOL_MOVE, keybind_new(/*"G"*/ STR(291)));
		keybind_register(/*"toolrotate"*/ STR(292), e_keybind_TOOL_ROTATE, keybind_new(/*"R"*/ STR(261)));
		keybind_register(/*"toolscale"*/ STR(293), e_keybind_TOOL_SCALE, keybind_new(/*"S"*/ STR(252)));
		keybind_register(/*"toolbend"*/ STR(294), e_keybind_TOOL_BEND, keybind_new(/*"B"*/ STR(295)));
		keybind_register(/*"tooltransform"*/ STR(296), e_keybind_TOOL_TRANSFORM, keybind_new(/*"T"*/ STR(297)));
		keybind_register(/*"snap"*/ STR(298), e_keybind_SNAP, keybind_new(/*"F"*/ STR(270)));
		keybind_register(/*"camforward"*/ STR(299), e_keybind_CAM_FORWARD, keybind_new(/*"W"*/ STR(289)), true);
		keybind_register(/*"camleft"*/ STR(300), e_keybind_CAM_LEFT, keybind_new(/*"A"*/ STR(265)), true);
		keybind_register(/*"camback"*/ STR(301), e_keybind_CAM_BACK, keybind_new(/*"S"*/ STR(252)), true);
		keybind_register(/*"camright"*/ STR(302), e_keybind_CAM_RIGHT, keybind_new(/*"D"*/ STR(263)), true);
		keybind_register(/*"camascend"*/ STR(303), e_keybind_CAM_ASCEND, keybind_new(/*"E"*/ STR(304)), true);
		keybind_register(/*"camdescend"*/ STR(305), e_keybind_CAM_DESCEND, keybind_new(/*"Q"*/ STR(272)), true);
		keybind_register(/*"camrollforward"*/ STR(306), e_keybind_CAM_ROLL_FORWARD, keybind_new(/*"Z"*/ STR(257)), true);
		keybind_register(/*"camrollback"*/ STR(307), e_keybind_CAM_ROLL_BACK, keybind_new(/*"C"*/ STR(274)), true);
		keybind_register(/*"camrollreset"*/ STR(308), e_keybind_CAM_ROLL_RESET, keybind_new(/*"X"*/ STR(276)), true);
		keybind_register(/*"camreset"*/ STR(309), e_keybind_CAM_RESET, keybind_new(/*"R"*/ STR(261)), true);
		keybind_register(/*"camfast"*/ STR(310), e_keybind_CAM_FAST, keybind_new(vk_space), true);
		keybind_register(/*"camslow"*/ STR(311), e_keybind_CAM_SLOW, keybind_new(null_, false, true), true);
		keybind_register(/*"camviewtimeline"*/ STR(312), e_keybind_CAM_VIEW_TIMELINE, keybind_new(/*"V"*/ STR(278)), false);
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::value_name_list, /*"POS_X"*/ STR(313), /*"POS_Y"*/ STR(314), /*"POS_Z"*/ STR(315), /*"ROT_X"*/ STR(316), /*"ROT_Y"*/ STR(317), /*"ROT_Z"*/ STR(318), /*"SCA_X"*/ STR(319), /*"SCA_Y"*/ STR(320), /*"SCA_Z"*/ STR(321), /*"BEND_ANGLE"*/ STR(322), /*"BEND_ANGLE_X"*/ STR(323), /*"BEND_ANGLE_Y"*/ STR(324), /*"BEND_ANGLE_Z"*/ STR(325), /*"ALPHA"*/ STR(326), /*"RGB_ADD"*/ STR(327), /*"RGB_SUB"*/ STR(328), /*"RGB_MUL"*/ STR(329), /*"HSB_ADD"*/ STR(330), /*"HSB_SUB"*/ STR(331), /*"HSB_MUL"*/ STR(332), /*"MIX_COLOR"*/ STR(333), /*"GLOW_COLOR"*/ STR(334), /*"MIX_PERCENT"*/ STR(335), /*"EMISSIVE"*/ STR(336), /*"METALLIC"*/ STR(337), /*"ROUGHNESS"*/ STR(338), /*"SUBSURFACE"*/ STR(339), /*"SUBSURFACE_RADIUS_RED"*/ STR(340), /*"SUBSURFACE_RADIUS_GREEN"*/ STR(341), /*"SUBSURFACE_RADIUS_BLUE"*/ STR(342), /*"SUBSURFACE_COLOR"*/ STR(343), /*"WIND_INFLUENCE"*/ STR(344), /*"SPAWN"*/ STR(345), /*"FREEZE"*/ STR(346), /*"CLEAR"*/ STR(347), /*"CUSTOM_SEED"*/ STR(348), /*"SEED"*/ STR(349), /*"ATTRACTOR"*/ STR(350), /*"FORCE"*/ STR(351), /*"FORCE_DIRECTIONAL"*/ STR(352), /*"FORCE_VORTEX"*/ STR(353), /*"LIGHT_COLOR"*/ STR(354), /*"LIGHT_STRENGTH"*/ STR(355), /*"LIGHT_SPECULAR_STRENGTH"*/ STR(356), /*"LIGHT_SIZE"*/ STR(357), /*"LIGHT_RANGE"*/ STR(358), /*"LIGHT_FADE_SIZE"*/ STR(359), /*"LIGHT_SPOT_RADIUS"*/ STR(360), /*"LIGHT_SPOT_SHARPNESS"*/ STR(361), /*"CAM_FOV"*/ STR(362), /*"CAM_BLADE_AMOUNT"*/ STR(363), /*"CAM_BLADE_ANGLE"*/ STR(364), /*"CAM_LIGHT_MANAGEMENT"*/ STR(365), /*"CAM_TONEMAPPER"*/ STR(366), /*"CAM_EXPOSURE"*/ STR(367), /*"CAM_GAMMA"*/ STR(368), /*"CAM_ROTATE"*/ STR(369), /*"CAM_ROTATE_DISTANCE"*/ STR(370), /*"CAM_ROTATE_ANGLE_XY"*/ STR(371), /*"CAM_ROTATE_ANGLE_Z"*/ STR(372), /*"CAM_SHAKE"*/ STR(373), /*"CAM_SHAKE_MODE"*/ STR(374), /*"CAM_SHAKE_STRENGTH_X"*/ STR(375), /*"CAM_SHAKE_STRENGTH_Y"*/ STR(376), /*"CAM_SHAKE_STRENGTH_Z"*/ STR(377), /*"CAM_SHAKE_SPEED_X"*/ STR(378), /*"CAM_SHAKE_SPEED_Y"*/ STR(379), /*"CAM_SHAKE_SPEED_Z"*/ STR(380), /*"CAM_DOF"*/ STR(381), /*"CAM_DOF_DEPTH"*/ STR(382), /*"CAM_DOF_RANGE"*/ STR(383), /*"CAM_DOF_FADE_SIZE"*/ STR(384), /*"CAM_DOF_BLUR_SIZE"*/ STR(385), /*"CAM_DOF_BLUR_RATIO"*/ STR(386), /*"CAM_DOF_BIAS"*/ STR(387), /*"CAM_DOF_THRESHOLD"*/ STR(388), /*"CAM_DOF_GAIN"*/ STR(389), /*"CAM_DOF_FRINGE"*/ STR(390), /*"CAM_DOF_FRINGE_ANGLE_RED"*/ STR(391), /*"CAM_DOF_FRINGE_ANGLE_GREEN"*/ STR(392), /*"CAM_DOF_FRINGE_ANGLE_BLUE"*/ STR(393), /*"CAM_DOF_FRINGE_RED"*/ STR(394), /*"CAM_DOF_FRINGE_GREEN"*/ STR(395), /*"CAM_DOF_FRINGE_BLUE"*/ STR(396), /*"CAM_BLOOM"*/ STR(397), /*"CAM_BLOOM_THRESHOLD"*/ STR(398), /*"CAM_BLOOM_INTENSITY"*/ STR(399), /*"CAM_BLOOM_RADIUS"*/ STR(400), /*"CAM_BLOOM_RATIO"*/ STR(401), /*"CAM_BLOOM_BLEND"*/ STR(402), /*"CAM_LENS_DIRT"*/ STR(403), /*"CAM_LENS_DIRT_BLOOM"*/ STR(404), /*"CAM_LENS_DIRT_GLOW"*/ STR(405), /*"CAM_LENS_DIRT_RADIUS"*/ STR(406), /*"CAM_LENS_DIRT_INTENSITY"*/ STR(407), /*"CAM_LENS_DIRT_POWER"*/ STR(408), /*"CAM_COLOR_CORRECTION"*/ STR(409), /*"CAM_CONTRAST"*/ STR(410), /*"CAM_BRIGHTNESS"*/ STR(411), /*"CAM_SATURATION"*/ STR(412), /*"CAM_VIBRANCE"*/ STR(413), /*"CAM_COLOR_BURN"*/ STR(414), /*"CAM_GRAIN"*/ STR(415), /*"CAM_GRAIN_STRENGTH"*/ STR(416), /*"CAM_GRAIN_SATURATION"*/ STR(417), /*"CAM_GRAIN_SIZE"*/ STR(418), /*"CAM_VIGNETTE"*/ STR(419), /*"CAM_VIGNETTE_RADIUS"*/ STR(420), /*"CAM_VIGNETTE_SOFTNESS"*/ STR(421), /*"CAM_VIGNETTE_STRENGTH"*/ STR(422), /*"CAM_VIGNETTE_COLOR"*/ STR(423), /*"CAM_CA"*/ STR(424), /*"CAM_CA_BLUR_AMOUNT"*/ STR(425), /*"CAM_CA_DISTORT_CHANNELS"*/ STR(426), /*"CAM_CA_RED_OFFSET"*/ STR(427), /*"CAM_CA_GREEN_OFFSET"*/ STR(428), /*"CAM_CA_BLUE_OFFSET"*/ STR(429), /*"CAM_DISTORT"*/ STR(430), /*"CAM_DISTORT_REPEAT"*/ STR(431), /*"CAM_DISTORT_ZOOM_AMOUNT"*/ STR(432), /*"CAM_DISTORT_AMOUNT"*/ STR(433), /*"CAM_SIZE_USE_PROJECT"*/ STR(434), /*"CAM_SIZE_KEEP_ASPECT_RATIO"*/ STR(435), /*"CAM_WIDTH"*/ STR(436), /*"CAM_HEIGHT"*/ STR(437), /*"BG_IMAGE_SHOW"*/ STR(438), /*"BG_IMAGE_ROTATION"*/ STR(439), /*"BG_SKY_MOON_PHASE"*/ STR(440), /*"BG_SKY_TIME"*/ STR(441), /*"BG_SKY_ROTATION"*/ STR(442), /*"BG_SUNLIGHT_STRENGTH"*/ STR(443), /*"BG_SUNLIGHT_ANGLE"*/ STR(444), /*"BG_SKY_SUN_ANGLE"*/ STR(445), /*"BG_SKY_SUN_SCALE"*/ STR(446), /*"BG_SKY_MOON_ANGLE"*/ STR(447), /*"BG_SKY_MOON_SCALE"*/ STR(448), /*"BG_TWILIGHT"*/ STR(449), /*"BG_SKY_CLOUDS_SHOW"*/ STR(450), /*"BG_SKY_CLOUDS_SPEED"*/ STR(451), /*"BG_SKY_CLOUDS_HEIGHT"*/ STR(452), /*"BG_SKY_CLOUDS_OFFSET"*/ STR(453), /*"BG_GROUND_SHOW"*/ STR(454), /*"BG_GROUND_SLOT"*/ STR(455), /*"BG_BIOME"*/ STR(456), /*"BG_SKY_COLOR"*/ STR(457), /*"BG_SKY_CLOUDS_COLOR"*/ STR(458), /*"BG_SUNLIGHT_COLOR"*/ STR(459), /*"BG_AMBIENT_COLOR"*/ STR(460), /*"BG_NIGHT_COLOR"*/ STR(461), /*"BG_GRASS_COLOR"*/ STR(462), /*"BG_FOLIAGE_COLOR"*/ STR(463), /*"BG_WATER_COLOR"*/ STR(464), /*"BG_LEAVES_OAK_COLOR"*/ STR(465), /*"BG_LEAVES_SPRUCE_COLOR"*/ STR(466), /*"BG_LEAVES_BIRCH_COLOR"*/ STR(467), /*"BG_LEAVES_JUNGLE_COLOR"*/ STR(468), /*"BG_LEAVES_ACACIA_COLOR"*/ STR(469), /*"BG_LEAVES_DARK_OAK_COLOR"*/ STR(470), /*"BG_LEAVES_MANGROVE_COLOR"*/ STR(471), /*"BG_FOG_SHOW"*/ STR(472), /*"BG_FOG_SKY"*/ STR(473), /*"BG_FOG_CUSTOM_COLOR"*/ STR(474), /*"BG_FOG_COLOR"*/ STR(475), /*"BG_FOG_CUSTOM_OBJECT_COLOR"*/ STR(476), /*"BG_FOG_OBJECT_COLOR"*/ STR(477), /*"BG_FOG_DISTANCE"*/ STR(478), /*"BG_FOG_SIZE"*/ STR(479), /*"BG_FOG_HEIGHT"*/ STR(480), /*"BG_WIND"*/ STR(481), /*"BG_WIND_SPEED"*/ STR(482), /*"BG_WIND_STRENGTH"*/ STR(483), /*"BG_WIND_DIRECTION"*/ STR(484), /*"BG_WIND_DIRECTIONAL_SPEED"*/ STR(485), /*"BG_WIND_DIRECTIONAL_STRENGTH"*/ STR(486), /*"BG_TEXTURE_ANI_SPEED"*/ STR(487), /*"TEXTURE_OBJ"*/ STR(488), /*"TEXTURE_MATERIAL_OBJ"*/ STR(489), /*"TEXTURE_NORMAL_OBJ"*/ STR(490), /*"SOUND_OBJ"*/ STR(491), /*"SOUND_VOLUME"*/ STR(492), /*"SOUND_PITCH"*/ STR(493), /*"SOUND_START"*/ STR(494), /*"SOUND_END"*/ STR(495), /*"TEXT"*/ STR(496), /*"TEXT_FONT"*/ STR(497), /*"TEXT_HALIGN"*/ STR(498), /*"TEXT_VALIGN"*/ STR(499), /*"TEXT_AA"*/ STR(500), /*"TEXT_OUTLINE"*/ STR(501), /*"TEXT_OUTLINE_COLOR"*/ STR(502), /*"CUSTOM_ITEM_SLOT"*/ STR(503), /*"ITEM_SLOT"*/ STR(504), /*"ITEM_NAME"*/ STR(505), /*"PATH_OBJ"*/ STR(506), /*"PATH_OFFSET"*/ STR(507), /*"PATH_POINT_ANGLE"*/ STR(508), /*"PATH_POINT_SCALE"*/ STR(509), /*"IK_TARGET"*/ STR(510), /*"IK_BLEND"*/ STR(511), /*"IK_TARGET_ANGLE"*/ STR(512), /*"IK_ANGLE_OFFSET"*/ STR(513), /*"VISIBLE"*/ STR(514), /*"TRANSITION"*/ STR(515), /*"EASE_IN_X"*/ STR(516), /*"EASE_IN_Y"*/ STR(517), /*"EASE_OUT_X"*/ STR(518), /*"EASE_OUT_Y"*/ STR(519) });
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(520), /*"spblock"*/ STR(521), /*"scenery"*/ STR(522), /*"item"*/ STR(523), /*"block"*/ STR(4), /*"bodypart"*/ STR(524), /*"particles"*/ STR(525), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(526), /*"cylinder"*/ STR(527), /*"sphere"*/ STR(528), /*"surface"*/ STR(529), /*"model"*/ STR(8) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(520), /*"spblock"*/ STR(521), /*"scenery"*/ STR(522), /*"item"*/ STR(523), /*"block"*/ STR(4), /*"bodypart"*/ STR(524), /*"particles"*/ STR(525), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(526), /*"cylinder"*/ STR(527), /*"sphere"*/ STR(528), /*"surface"*/ STR(529), /*"model"*/ STR(8), /*"camera"*/ STR(126), /*"spotlight"*/ STR(530), /*"pointlight"*/ STR(531), /*"folder"*/ STR(532), /*"background"*/ STR(219), /*"audio"*/ STR(533), /*"path"*/ STR(534), /*"pathpoint"*/ STR(535), /*"shape"*/ STR(536), /*"lightsource"*/ STR(537) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(538), /*"packunzipped"*/ STR(539), /*"skin"*/ STR(540), /*"downloadskin"*/ STR(204), /*"itemsheet"*/ STR(541), /*"legacyblocksheet"*/ STR(542), /*"blocksheet"*/ STR(543), /*"scenery"*/ STR(522), /*"fromworld"*/ STR(544), /*"particlesheet"*/ STR(545), /*"texture"*/ STR(546), /*"font"*/ STR(547), /*"sound"*/ STR(548), /*"model"*/ STR(8) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(549), /*"instant"*/ STR(550), /*"bezier"*/ STR(551), /*"easeinquad"*/ STR(552), /*"easeoutquad"*/ STR(553), /*"easeinoutquad"*/ STR(554), /*"easeincubic"*/ STR(555), /*"easeoutcubic"*/ STR(556), /*"easeinoutcubic"*/ STR(557), /*"easeinquart"*/ STR(558), /*"easeoutquart"*/ STR(559), /*"easeinoutquart"*/ STR(560), /*"easeinquint"*/ STR(561), /*"easeoutquint"*/ STR(562), /*"easeinoutquint"*/ STR(563), /*"easeinsine"*/ STR(564), /*"easeoutsine"*/ STR(565), /*"easeinoutsine"*/ STR(566), /*"easeinexpo"*/ STR(567), /*"easeoutexpo"*/ STR(568), /*"easeinoutexpo"*/ STR(569), /*"easeincirc"*/ STR(570), /*"easeoutcirc"*/ STR(571), /*"easeinoutcirc"*/ STR(572), /*"easeinelastic"*/ STR(573), /*"easeoutelastic"*/ STR(574), /*"easeinoutelastic"*/ STR(575), /*"easeinback"*/ STR(576), /*"easeoutback"*/ STR(577), /*"easeinoutback"*/ STR(578), /*"easeinbounce"*/ STR(579), /*"easeoutbounce"*/ STR(580), /*"easeinoutbounce"*/ STR(581) });
		global::transition_list_order = ds_list_create();
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (!string_contains(DsList(global::transition_list).Value(i), /*"ease"*/ STR(582)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easein"*/ STR(583)) && !string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(584)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeout"*/ STR(585)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(584)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		log({ /*"Make transitions"*/ STR(586) });
		...
		log({ /*"Transitions OK"*/ STR(587) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(588), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(589), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(590), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(591), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(592), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(593), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(594), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(595), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(596), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(597), IntType(5000000)), new_videoquality(/*"high"*/ STR(598), IntType(2500000)), new_videoquality(/*"medium"*/ STR(599), IntType(1200000)), new_videoquality(/*"low"*/ STR(600), IntType(700000)), new_videoquality(/*"verylow"*/ STR(601), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(602), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(603), /*"add"*/ STR(604), /*"subtract"*/ STR(605), /*"multiply"*/ STR(606), /*"screen"*/ STR(607) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(603), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(604), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(605), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(606), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(607), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(608), /*"diffuse"*/ STR(609), /*"specular"*/ STR(610), /*"ao"*/ STR(611), /*"shadows"*/ STR(129), /*"indirect"*/ STR(131), /*"indirectshadows"*/ STR(612), /*"reflections"*/ STR(132), /*"depth"*/ STR(613), /*"normal"*/ STR(603), /*"material"*/ STR(614) });
	}
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(616);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(617)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(618)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(619)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(620)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(621)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(622)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(623)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(624)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(625)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(626));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(627));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(628));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(629));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(630));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(631));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(632));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(633));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(634));
			self->green_success = hex_to_color(/*"61C159"*/ STR(635));
			self->red = hex_to_color(/*"FF5656"*/ STR(636));
			self->green = hex_to_color(/*"4AB758"*/ STR(637));
			self->blue = hex_to_color(/*"1370FB"*/ STR(638));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(639));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(640));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(641));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(642));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(643));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(644));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(645));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(633));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(646);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(647)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(648)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(649)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(650)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(651)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(652)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(653)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(654)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(655)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(656));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(657));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(658));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(657));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(659));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(632));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(660));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(661));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(662));
			self->green_success = hex_to_color(/*"64E879"*/ STR(663));
			self->red = hex_to_color(/*"FF5656"*/ STR(636));
			self->green = hex_to_color(/*"23FF88"*/ STR(664));
			self->blue = hex_to_color(/*"1370FB"*/ STR(638));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(639));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(640));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(665));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(642));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(666));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(663));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(662));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(661));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(667);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(647)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(654)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(655)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(668));
			self->level_middle = hex_to_color(/*"101010"*/ STR(669));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(670));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(671));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(672));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(632));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_startup_window(ScopeAny self)
	{
		...
		sStr(popup_block_ani_ease) = /*"easeoutcirc"*/ STR(571);
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(602) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), (IntType)(hex_to_color(/*"020204"*/ STR(674))), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(675), global::_app->project_changed) + /*" - Mine-imator"*/ STR(676));
		else
			window_set_caption(/*"Mine-imator"*/ STR(23));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(677));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(678));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(679));
	...
	void app_update_keyboard(ScopeAny self)
	{
		if (dev_mode)
		{
			...
			if (keyboard_check_pressed(vk_f9))
				open_url(self, file_directory);
			if (keyboard_check_pressed(vk_f10))
				open_url(self, gmlGlobal::working_directory);
		}
		if (keyboard_check_pressed(vk_f11))
			open_url(self, log_file);
		if (keyboard_check_pressed(vk_f12))
			sBool(debug_info) = !sBool(debug_info);
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(680)) && !sBool(textbox_isediting))
		{
